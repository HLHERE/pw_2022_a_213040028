...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <div class="content" style="padding-top: 100px; padding-bottom: 200px;">
        <h1 style="text-align: center;">Form tambah data ambulance </h1>
...
<form action="" method="post" autocomplete="off" enctype="multipart/form-data">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="Ambulance" name="Ambulance" required>
  </div>
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <button type="submit" class="btn btn-danger" name="tambah" style="margin-top: 35px;">tambah data Ambulance </button>
  </div>
</form>
</div>
</div> 
